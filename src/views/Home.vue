...
<template>
   <div class="space-y-16 bg-[#0060bf] text-white">
    <div class="max-w-2xl px-6 py-24 mx-auto w-full space-y-4 text-center">
      <h1 class="text-5xl font-bold leading-none mb-10">Bonjour !</h1>
