...
<template>
      <div class="px-4 py-6 dark:bg-gray-100 dark:text-gray-600">
      <div
        class="container flex flex-wrap items-center justify-center mx-auto space-y-4 sm:space-y-0"
      >
        <div class="flex flex-row pr-8 space-x-4 sm:space-x-8">
          <div
            class="flex items-center justify-center flex-shrink-0 w-12 h-12 rounded-full dark:bg-[#0060bf]"
          >
            <svg
        ...
        <ul class="flex flex-wrap pl-8 space-x-4 sm:space-x-8">
          <li>
      ...
      <div class="flex items-center justify-center pt-6 text-md">
